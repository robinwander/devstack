...
export const LogRow = memo(function LogRow({
  ...
  const levelTint =
    level === "error" ? "log-level-error-tint"
    : level === "warn" ? "log-level-warn-tint"
    : "";

  const levelStrip =
    level === "error" ? "log-level-error-strip"
    : level === "warn" ? "log-level-warn-strip"
    : "";
  ...
  return (
    ...
    >
      ...
      {isExpanded && (
        <LogDetail log={log} svcColorClass={svcColorClass} />
      )}
    </div>
  );
});
