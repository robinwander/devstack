...
use crate::api::{
    ...
    GlobalsResponse, HealthStatus, KillRequest, LatestAgentSessionResponse, LogEntry,
    LogFacetsQuery, LogFacetsResponse, LogSearchQuery, LogSearchResponse, LogsQuery, LogsResponse,
...
#[openapi(
    paths(
        ...
        crate::daemon::logs,
        crate::daemon::logs_search,
        crate::daemon::logs_facets,
        ...
        crate::daemon::source_logs,
        crate::daemon::source_log_facets,
